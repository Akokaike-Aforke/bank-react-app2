...
const[person, setPerson] = useState({viewDashboard: true, transferLog:false, openDeposit:false, openDashboard:false, viewMyAccounts: false, viewMore: false, doMoreView: false, dashboardMain: true, dashboardOptionShow: true, dashboardBackground: true})
