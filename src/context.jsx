...
const[person, setPerson] = useState({transferLog:false, openDeposit:false, openDashboard:false, viewMyAccounts: false, viewMore: false, doMoreView: true, dashboardMain: false})
