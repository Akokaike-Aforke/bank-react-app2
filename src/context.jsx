...
const[person, setPerson] = useState({viewDashboard: false, transferLog:false, openDeposit:false, openDashboard:false, viewMyAccounts: false, viewMore: false, doMoreView: false, dashboardMain: true, dashboardOptionShow: true, dashboardBackground: true})
