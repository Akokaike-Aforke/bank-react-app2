...
const Profile = ({ data, isLoading, setProfileOpen }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    accountType: dashboardUser.accountType,
    pin: dashboardUser.pin,
    currentPin: "",
    newPin: "",
    confirmNewPin: "",
    currentPassword: "",
  ...
  const handleSubmitPin = (e) => {
    ...
    e.preventDefault;
    editUser(
      { userId: dashboardUser._id, pin: formData.newPin },
      {
        onSuccess: () => {
          setEditButtons({ ...editButtons, changePin: false });
        },
      },
      {
        onError: (error) => {
  ...
  const handleSubmitPassword = (e) => {
    e.preventDefault;
    editUser(
      { userId: dashboardUser._id, password: formData.newPassword },
      {
        onSuccess: () => {
          setEditButtons({ ...editButtons, changePassword: false });
        },
      },
      {
        onError: (error) => {
  ...
  useEffect(() => {
    if (
      ...
      setEditButtons({ ...editButtons, deleteAccount: false });
    }
        ...
        {!editButtons.changeSecureLog ? (
          <div>
            ...
            <div className="photo-div">
              <form className="photo-form" onSubmit={handleFileChange}>
                ...
                <input
                  ...
                  name="profilePhoto"
                />
                <button className="profile-btn" onClick={handleFileChange}>
                  SAVE
                </button>
              </form>
            ...
            <div>
              <form action="">
                <label htmlFor="profile-customer-name">Customer Name</label>
                <input id="profile-customer-name" type="text" />
                <BiEdit />
              </form>
              <h5>Username</h5>
              <p>{}</p>
              <button>SHOW BVN</button>
            </div>
            <div>
              <h5>LINKS</h5>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="profile-details-noInput">
                ...
                <h5 className="h5NoInput">
                  {dashboardUser?.accounts[selectedAccount]?.accountNumber}
                </h5>
              </div>
              <div className="profile-details-noInput">
                ...
                <h5 className="h5NoInput">
                  {getFormattedDate(
                    dashboardUser?.accounts[selectedAccount]?.dateCreated
                  )}
                </h5>
              </div>
              <button
